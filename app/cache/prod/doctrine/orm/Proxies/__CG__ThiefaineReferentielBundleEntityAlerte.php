 ...
 */
class Alerte extends \Thiefaine\ReferentielBundle\Entity\Alerte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Thiefaine\\ReferentielBundle\\Entity\\Alerte' . "\0" . 'id', '' . "\0" . 'Thiefaine\\ReferentielBundle\\Entity\\Alerte' . "\0" . 'idzone', '' . "\0" . 'Thiefaine\\ReferentielBundle\\Entity\\Alerte' . "\0" . 'idmessage', '' . "\0" . 'Thiefaine\\ReferentielBundle\\Entity\\Alerte' . "\0" . 'message', '' . "\0" . 'Thiefaine\\ReferentielBundle\\Entity\\Alerte' . "\0" . 'zone');
        }
