 ...
 */
class Typemessage extends \Thiefaine\ReferentielBundle\Entity\Typemessage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Thiefaine\\ReferentielBundle\\Entity\\Typemessage' . "\0" . 'id', '' . "\0" . 'Thiefaine\\ReferentielBundle\\Entity\\Typemessage' . "\0" . 'libelle', '' . "\0" . 'Thiefaine\\ReferentielBundle\\Entity\\Typemessage' . "\0" . 'messages');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Typemessage $proxy) {
