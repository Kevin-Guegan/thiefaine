...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'referentiel', 'user' => 'root', 'password' => 'thiefaine', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_42716cdec866675189dcb7a779caf4ec2d31f05a0156594b715c14126bb46bd4');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_42716cdec866675189dcb7a779caf4ec2d31f05a0156594b715c14126bb46bd4');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_42716cdec866675189dcb7a779caf4ec2d31f05a0156594b715c14126bb46bd4');
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(__DIR__.'/../../../src/Thiefaine/ReferentielBundle/Resources/config/doctrine' => 'Thiefaine\\ReferentielBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(__DIR__.'/../../../src/Thiefaine/ReferentielBundle/Resources/views', 'ThiefaineReferentiel');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => __DIR__.'/../../../vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
