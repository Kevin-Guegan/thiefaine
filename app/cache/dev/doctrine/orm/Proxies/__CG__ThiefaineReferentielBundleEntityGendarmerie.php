...
class Gendarmerie extends \Thiefaine\ReferentielBundle\Entity\Gendarmerie implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Thiefaine\\ReferentielBundle\\Entity\\Gendarmerie' . "\0" . 'id', '' . "\0" . 'Thiefaine\\ReferentielBundle\\Entity\\Gendarmerie' . "\0" . 'libelle', '' . "\0" . 'Thiefaine\\ReferentielBundle\\Entity\\Gendarmerie' . "\0" . 'groups');
        }
