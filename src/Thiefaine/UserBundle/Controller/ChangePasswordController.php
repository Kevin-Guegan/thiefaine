...
class ChangePasswordController extends BaseController
{
    ...
    public function renderResponse($form,$show){
        $parameter = $this->container->getParameter('fos_user.template.engine');
        return $this->container->get('templating')->renderResponse('FOSUserBundle:ChangePassword:changePassword.html.'.$parameter,
            array(
    ...
    public function changePasswordAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ('' === $notice && false === $form->isValid()) {
                $notice = 'Le mot de passe doit contenir au moins 2 caractères.';
            }
